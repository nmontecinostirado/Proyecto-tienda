...
Formulario demostrativo que utiliza diferentes tipos de controles introducidos en HTML5, junto con validaciones nativas del navegador. Además, este proyecto incorpora una mini-tienda funcional creada con HTML, Bootstrap y JavaScript, incluyendo un sistema de carrito, vista de productos, modal interactivo y búsqueda.
